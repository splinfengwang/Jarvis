...
- `references/write-permission.md` — 写入裁决规则
- `references/knowledge-base-structure.md` — 目录树规范
...
3.1 运行 `jarvis init <项目路径>`：
  - CLI 处理目录创建、软链接、模板生成、jarvis.yaml 写入
  - 阶段 2 已决定的 CLAUDE.md 处理方式通过 CLI 交互传递
  - **注意**：如果 CLI 提示已有 CLAUDE.md 选择，按阶段 2 已协商好的选择输入
